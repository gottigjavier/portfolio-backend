package com.gottig.portfolio.jwtsecurity.jwtconfig;

import com.gottig.portfolio.jwtsecurity.jwtepf.JwtEntryPoint;
import com.gottig.portfolio.jwtsecurity.jwtepf.JwtTokenFilter;
import com.gottig.portfolio.jwtsecurity.jwtservice.JwtUserDetailsServiceImpl;
...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                .authorizeRequests()
                .antMatchers("/auth/login", "/**/list").permitAll()
